...
struct ProjectCard: View {
    ...
    var backgroundColor: Color {
        Color.beige // Assuming this is from your asset or extension
    }
    ...
    var body: some View {
        ZStack {
            ...
            .padding()
            .background(Color(red: 172/255, green: 179/255, blue: 230/255)) // Card background
            .cornerRadius(20)
            .padding(.horizontal)
        }
    }
...
struct joinProject: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .background(Color.beige) // ✅ Ensure beige background behind scroll content
        }
